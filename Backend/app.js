...
mongoose.connect(process.env.DBURL_DB, {useNewUrlParser:true, useUnifiedTopology:true})

.then(res=>{
    app.listen(process.env.PORT, ()=>{
        console.log(`Server is running at hostname ${hostname}:port ${process.env.PORT}, in ${process.env.NODE_ENV} MODE`);
    })
})
